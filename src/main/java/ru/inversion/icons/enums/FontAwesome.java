...
/**<a href="http://fontawesome.io/cheatsheet/">Ссылка на предпросмотр</a>*/
public enum FontAwesome implements TTFChar {
	fa_glass("\uf000"),
	fa_music("\uf001"),
	fa_search("\uf002"),
	fa_envelope_o("\uf003"),
	...
	private final static String fontFamily = "FontAwesome";
	private final static String prefix = "fa";
	FontAwesome(String s){
		this.code = s;
	}
