...
public class ViewPrintController extends JInvFXBrowserController {
  ...
  private void view() {
    if (this.getInitProperties().get(ExportSettings.KEY_SOURCE) instanceof JInvTable) ;
    {
      ...
      Export.getTableReport(((JInvTable) this.getInitProperties().get(ExportSettings.KEY_SOURCE)), ExportFormatEnum.Html, ExportSettings.getExpTempDir(), exportSettings, SizeExportedDataEnum.DISPLAYED_TABLE);
    }
  ...
  @Override
  public void initFormController(TaskContext tc,
                                 ViewContext vc,
                                 FormModeEnum dialogMode,
                                 Object dataObject,
                                 Property<FormReturnEnum> returnProperty,
                                 Map<String, Object> properties,
                                 Consumer<ResultForm<Object>> clb,
