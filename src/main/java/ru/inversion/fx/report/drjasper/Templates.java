...
import net.sf.dynamicreports.report.base.expression.*;
...
import net.sf.dynamicreports.report.definition.*;
...
//        columnTitleStyle.addConditionalStyle(stl.)
...
//        footerComponent = cmp.pageXofY().setStyle(stl.style(boldCenteredStyle).setTopBorder(stl.pen1Point()));
     ...
     * @return a {@link ComponentBuilder} object.
     */
