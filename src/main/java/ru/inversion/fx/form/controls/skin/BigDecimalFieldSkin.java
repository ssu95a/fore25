 ...
 * @author zarubin
 */
public class BigDecimalFieldSkin extends SkinBase<JInvBigDecimalSpinner> {

    private JInvBigDecimalSpinner CONTROL;

    public BigDecimalFieldSkin(JInvBigDecimalSpinner control) {
        super(control);
    ...
    public JInvBigDecimalSpinner getControl() {
        return CONTROL;
    }
...
//
    ...
    /**
     * When the CONTROL or the textfield of the Skin gains the focus we make
     * that visible by adding/removing a CSS style that visually simulates the
     * focus.
     *     
*/
